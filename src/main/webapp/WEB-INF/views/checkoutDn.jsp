...
<script>
    ...
    window.onload = function () {
        ...
        console.log(giaBanInput1.value);
    };
</script>
        ...
        <div class="pos_page_inner">
            ...
            <div class="Checkout_section">
                ...
                <div class="checkout_form">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <form id="paymentForm" action="/addHDDn/${kh.maKhachHang}" method="get">
                                <input type="text" name="maChiTietSanPham" id="maChiTietSanPham"
                                       value="${lol.maChiTietSanPham}" hidden>
                                ...
                                <div class="row">
                                    <div class="col-12 mb-30">
                                        ...
                                        <input type="text" id="nguoiNhan" class="form-control" name="nguoiNhan"
                                               value="${kh.ten}" required>
                                        <span id="nguoiNhanError" class="error"></span>
                                    </div>
                                    <div class="col-12 mb-30">
                                        <label>Số điện thoại người nhận:</label>
                                        <input type="text" id="sdt" class="form-control" name="sdt" value="${kh.sdt}"
                                               required>
                            ...
                            <form action="/addHDDnVi/${kh.maKhachHang}" method="get" id="secondForm1">
                                ...
                                <input type="text" id="maVoucher2" class="form-control" name="maVoucher2"
                                       required hidden>
                                <div class="col-12 mb-30">
                                    <input type="number" id="tongSoTien" name="tongTien1"
                                           value="${tongTien}" hidden>
                                </div>
                                <div class="order_button">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <form action="/submitOrder2" method="post" id="secondForm">
                                ...
                                <div class="order_table table-responsive mb-30">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <%--                                                        ${(lol.giaBan * sl)}--%>
                                                <script>document.write(formatCurrencyVND(${(lol.giaBan * sl)}))</script>
                                            </td>
                                            <td>
                                                <script>document.write(formatCurrencyVND(${tongTien}))</script>
                                            </td>
                                            <input type="hidden" name="giaSauGiam" value="${giaBan}">
                                        </tr>
                                        <br>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="coupon_code">
                                        ...
                                        <div class="coupon_inner">
                                            ...
                                            <select class="form-control" name="maVoucher" id="voucher"
                                                    onchange="displayDiscountInfo()">
                                                <option value="">-- Chọn voucher --</option>
                                                <c:forEach items="${listVoucher}" var="v">
                                                    <option value="${v.maVoucher}"
                                                            data-discount="${v.phanTramVoucher}">${v.ten}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    <label>Tổng tiền:</label>
                                    <input type="text" class="form-control" readonly id="tongTienBanDau"
                                           value="${tongTien}">
...
<script>
    ...
    function submitSecondForm1() {
        ...
        // document.getElementById('secondForm1').elements['tongSoTien'].value = tt;
        // document.getElementById('secondForm1').elements['tienVi'].value = tienVi;
...
<script>
    function displayDiscountInfo() {
        ...
        if (selectedOption) {
            ...
            discountInfoInput.value = "";
            tongTienInput.value = formatCurrencyVND(${tongTien});
            tongTienInput1.value = formatCurrencyVND(${tongTien});
            tongTienInputVi.value = (${tongTien});
            maVoucher1.value = "";
            maVoucher2.value = "";
            maVoucher3.value = "";
