<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            <title>Đăng nhập quản trị AZURA</title>
            <meta charset="UTF-8">
            ...
            <link rel="stylesheet" type="text/css" href="../../../assetsAdmin/css/main2.css">
        ...
        <body>
                ...
                <div class="container-login100">
                    <div class="wrap-login100">
                        <div class="login100-pic js-tilt" data-tilt>
                            <img src="${pageContext.request.contextPath}/assets/img/logo/AZURA.png" alt="IMG">
                        </div>
                        <!--=====TIÊU ĐỀ======-->
                        <form action="/admin/login" method="POST" class="login100-form validate-form">
                            ...
                            <div class="wrap-input100 validate-input">
                                <input class="input100" type="email" placeholder="Tài khoản quản trị" name="username"
            ...
            <!--Javascript-->
            <script src="../../../assetAdmin/js/main2.js"></script>
