                ...
                <body class="app sidebar-mini rtl">
                    ...
                    <script>
                        ...
                        $(document).ready(function () {
                            ...
                            function displayResults(results) {
                                ...
                                for (var i = 0; i < results.length; i++) {
                                    ...
                                    var row = "<tr>" +
                                        ...
                                        "<td>" +
                                        "<button class='btn btn-primary btn-sm' onclick='viewDetail(" + wr.maBaoHanh + ")' title='Xem chi tiết'>" +
                                        "<i class='fa fa-eye'></i>" +
                                        "</button>" +
                                        "</td>" +
                                        "</tr>";
                            ...
                            function viewDetail(maBaoHanh) {
                                // TODO: Implement view detail functionality
                                alert('Xem chi tiết yêu cầu bảo hành #' + maBaoHanh);
                                // window.location.href = "/admin/warranty/detail/" + maBaoHanh;
                            }
                        });
