...
<head>
    <title>Danh sách nhà sản xuất | Quản trị Admin</title>
    <meta charset="utf-8">
...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item active"><a href="#"><b>Danh sách nhà sản xuất</b></a></li>
        </ul>
        <div id="clock"></div>
    </div>
                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="/admin/${nhanVien.maNhanVien}/add/quan-li-nsx" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới nhà sản xuất</a>
                        </div>
                    </div>
                    <div id="divPrint">
                        <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                            ...
                            <c:forEach items="${listNSX}" var="nsx">
                                <tr>
                                    ...
                                    <td>${nsx.maNSX}</td>
                                    <td>${nsx.tenNSX}</td>
                                    <td><span class='${nsx.trangThai == 1 ? 'badge bg-success' : ' badge bg-danger'}'>${nsx.trangThai == 1? "Hoạt động": "Ngừng hoạt động"}</span></td>
                                    <td>
                                        <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
                                                onclick="return deleteRow(${nsx.maNSX})"><i
                                                class="fas fa-trash-alt"></i>
                                        </button>
                                        <button class="btn btn-primary btn-sm edit" type="button" title="Sửa"
                                                data-toggle="modal" data-target="#ModalNVUP" onclick="editNSX(this)">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <span class="thong-tin-thanh-toan">
                <h5>Thông tin nhà sản xuất cơ bản</h5>
              </span>
                    </div>
                </div>
                <form class="row" id="form-update">
                    <div class="form-group col-md-6">
                        <label class="control-label">ID NSX</label>
                        <input class="form-control" id="maNSX" name="maNSX" type="text" required value="" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="control-label">Tên NSX *</label>
                        <input class="form-control" id="ten" name="tenNSX" type="text" required value="">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <a class="btn btn-cancel" href="/admin/${nhanVien.maNhanVien}/quan-li-nsx">Hủy bỏ</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    function deleteRow(maNSX) {
        swal({
            title: "Cảnh báo",
            text: "Bạn có chắc chắn là muốn xóa nhà sản xuất này?",
                ...
                fetch('/nsx/xoa/' + maNSX, {
                    ...
                    .then(response => {
                        if (response.ok) {
                            ...
                            setTimeout(() => {
                                window.location.href = '/admin/${nhanVien.maNhanVien}/quan-li-nsx';
                            }, 2000);
                        } else {
    ...
    function editNSX(button) {
        var row = button.closest("tr");
        var maNSX = row.cells[1].innerText;
        var ten = row.cells[2].innerText;
        var trangThai = row.cells[3].innerText;

        document.getElementById("maNSX").value = maNSX;
    ...
    function saveNSX(e) {
        ...
        }).then((res) => window.location.href = '/admin/${nhanVien.maNhanVien}/quan-li-nsx');
    }
