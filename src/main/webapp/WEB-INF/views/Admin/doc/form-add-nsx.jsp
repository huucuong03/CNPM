...
<head>
    <title>Thêm nhà sản xuất | Quản trị Admin</title>
    <meta charset="utf-8">
...
<%--                            <input class="form-control" type="text" name="maNSX" disabled>--%>
<%--                        </div>--%>
                        <div class="form-group col-md-6">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-1">
                                    <button class="btn btn-save" type="button" onclick="addNsx()">Lưu lại</button>
                                </div>
                                <div class="col-1">
...
<script>
    function addNsx() {
        ...
        if (ten.trim() === "") {
            ...
            swal("Lỗi!", "Vui lòng nhập tên NSX.", "error");
                ...
                fetch("/nsx/them", {
                    ...
                    .then((response) => {
                        if (response === "Success") {
                            ...
                            swal("Thành công!", "NSX đã được thêm thành công.", "success")
                                .then(() => {
                                    // Sau khi người dùng đóng SweetAlert, chuyển hướng đến trang quản lý NSX
                    ...
                    .catch((error) => {
                        ...
                        swal("Lỗi!", "Đã xảy ra lỗi khi thêm NSX.", "error");
                    });
            } else {
                // User clicked "Hủy bỏ"
                swal("Hủy bỏ", "Bạn đã hủy thêm NSX.", "info");
            }
        });
    }
