...
<head>
    <title>Thêm màu | Quản trị Admin</title>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile">
                ...
                <h3 class="tile-title">Tạo mới màu sắc</h3>
                <div class="tile-body">
                    <form class="row" >
<%--                        <div class="form-group col-md-4">--%>
<%--                            <label class="control-label">ID màu</label>--%>
<%--                            <input class="form-control" type="text" name="maMau" disabled>--%>
<%--                        </div>--%>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-1">
                                    <button class="btn btn-save" type="button" onclick="saveMauSac()">Lưu lại</button>
                                </div>
                                <div class="col-1">
...
<script>
    ...
    function saveMauSac() {
        ...
        if (ten.trim() === "") {
            ...
            swal("Lỗi!", "Vui lòng nhập tên Màu Sắc.", "error");
        ...
        swal({
            title: "Xác nhận",
            text: "Bạn có muốn thêm màu sắc này?",
            icon: "info",
                ...
                fetch("/mau-sac/them", {
                    ...
                    .then((response) => {
                        if (response === "Success") {
                            ...
                            swal("Thành công!", "Màu sắc đã được thêm thành công.", "success")
                                .then(() => {
                                    // Sau khi người dùng đóng SweetAlert, chuyển hướng đến trang quản lý màu sắc
                    ...
                    .catch((error) => {
                        ...
                        swal("Lỗi!", "Đã xảy ra lỗi khi thêm màu sắc.", "error");
                    });
            } else {
                // User clicked "Hủy bỏ"
                swal("Hủy bỏ", "Bạn đã hủy thêm màu sắc.", "info");
            }
        });
    }
