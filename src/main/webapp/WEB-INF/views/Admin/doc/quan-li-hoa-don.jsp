        ...
        <%@ page isELIgnored="false" %>
            ...
            <body onload="time()" class="app sidebar-mini rtl">
                ...
                <main class="app-content">
                                ...
                                <div class="tile-body">
                                    <form class="row" id="searchForm">
                                        <div class="form-group col-md-4 ">
                                            ...
                                            <input id="khachHangSearch" class="form-control" type="text"
                                                name="khachHang">
                                        </div>
                                        <div class="form-group col-md-4 ">
                                            <label for="nguoiNhanSearch" class="control-label">Người nhận</label>
                                            <input id="nguoiNhanSearch" class="form-control" type="text"
                                                name="nguoiNhan">
                                        </div>
                                        <div class="form-group col-md-4 ">
                                    ...
                                    <div class="row element-button">
                                        <div class="col-sm-2">
                                            <button class="btn btn-excel btn-sm" href="" title="In" type="submit"
                                                form="searchForm"><i class="fas fa-search"></i>Tìm
                                                kiếm
                                            </button>
                                        </div>
                                        <div class="col-sm-2">
                    ...
                    <div class="modal fade" id="ModalUPTT" tabindex="-1" role="dialog" aria-hidden="true"
                                        ...
                                        <section class="content" style="margin-bottom: 20px; text-align: center">
                                            <form id="form-xac-nhan-update">
                                                <div id="no_1_1" style="display: none;">
                                                    <a class="btn btn-info btn-sm" type="submit"
                                                        onclick="updateConfirm(1)">Xác nhận</a>
                                                    <%-- <a class="btn btn-danger btn-sm" type="button"
                                                        onclick="updateConfirm(3)">Hủy--%>
                                                        <%-- đơn</a>--%>
                                                            <a class="btn btn-danger btn-sm" type="button"
                                                                data-toggle="modal" data-target="#cancelReasonModal">Hủy
                                                                đơn</a>
                                                ...
                                                <div id="no_2_2" style="display: none;">
                                                    <a class="btn btn-success btn-sm" type="submit"
                                                        onclick="updateConfirmHoanThanh(2)">Hoàn
                                                        thành</a>
                                                ...
                                                <div id="no_5_5" style="display: none;">
                                                    <!-- Button group cho đơn hàng tại quầy -->
                                                    <a class="btn btn-success btn-sm" type="submit"
                                                        onclick="updateConfirmHoanThanh(2)">Hoàn
                                                        thành</a>
                                                    <a class="btn btn-cancel" data-dismiss="modal" href="#">Thoát</a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="cancelReasonModalLabel1">Lý do giao hàng
                                                    thất bại</h5>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">Đóng</button>
                                                <button type="button" class="btn btn-primary"
                                                    onclick="cancelOrder()">Xác nhận hủy
                                                </button>
                                            </div>
                                        </div>
                                    </div>
    ...
    -->
                ...
                <script>
                    ...
                    function updateConfirm(trangThai) {
                        ...
                        if (hasDuplicateIMEI(danhSachSanPhamHoaDonDTOS)) {
                            Swal.fire({
                                icon: 'warning',
                                title: 'Thông báo',
                    ...
                    // Hàm kiểm tra sự trùng lặp của IMEI trong danh sách sản phẩm của hóa đơn
                    function hasDuplicateIMEI(danhSachSanPhamHoaDonDTOS) {
                        var imeiSet = new Set();
                        for (var i = 0; i < danhSachSanPhamHoaDonDTOS.length; i++) {
                            var imei = danhSachSanPhamHoaDonDTOS[i].imei;
                            if (imei && imeiSet.has(imei)) {
                    ...
                    function updateConfirmHoanThanh(trangThai) {
                        ...
                        console.log('Request Hoàn thành:', request);
                    ...
                    $(document).on("click", ".edit", function () {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                // Button groups
                                var no_1_1 = document.getElementById("no_1_1");
                                var no_2_2 = document.getElementById("no_2_2");
                                var no_3_3 = document.getElementById("no_3_3");
                                var no_5_5 = document.getElementById("no_5_5");
                                ...
                                for (var i = 0; i < thImeiColumn.length; i++) {
                                    ...
                                    // Cho phép chỉnh sửa IMEI cho trạng thái 1 (Đang giao hàng) và 4 (Quầy)
                                    if (data.trangThai === 2 || data.trangThai === 3 || data.trangThai === 5) {
                                        thImei.readOnly = true;
                                    } else {
                                        thImei.readOnly = false;
                                    }
                                }
                                if (data.trangThai === 0) {
                                ...
                                if (data.trangThai === 4) {
                                    // Hiển thị nút Hoàn thành cho đơn hàng tại quầy (không có nút Giao hàng thất bại)
                                    no_5_5.style.display = "block";
                                    no_1_1.style.display = "none";
                                    no_2_2.style.display = "none";
                                    no_3_3.style.display = "none";
                    ...
                    function fillCtSPOfHoaDon(results) {
                        ...
                        for (var i = 0; i < results.length; i++) {
                            ...
                            var row = "<tr>" +
                                ...
                                "<td><input type='text' class='form-control col-md-12 thImei' value='" + (ctsp.imei || '') + "'>" + "</td>"
                                + "</tr>";
                            tableBody.append(row);
                        }
                    ...
                    function getDSSPOfHDCT() {
                        ...
                        $('#sampleTable2 tbody tr').each(function () {
                            var row = $(this);

                            var maHDCT = row.find('td:eq(0)').text();
                            var imei = row.find('td:eq(6) input').val();

                            console.log('maHDCT:', maHDCT, 'imei:', imei); // Debug log
                        ...
                        console.log('Danh sách sản phẩm:', danhSachSanPhamHoaDonDTOS); // Debug log
