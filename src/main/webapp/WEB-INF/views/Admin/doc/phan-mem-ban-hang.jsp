            ...
            <body onload="time()" class="app sidebar-mini rtl">
                ...
                <header class="app-header">
                    ...
                    <ul class="app-nav">
                        ...
                        <li><a class="app-nav__item" href="/admin/admin-login"><i
                        ...
                        <div class="col-md-8">
                            <div class="tile">
                                ...
                                <div class="alert">
                                    ...
                                    <i class="fas fa-exclamation-triangle"></i> Gõ mã hoặc tên sản phẩm vào thanh tìm
                                    kiếm để thêm hàng
                                    vào đơn hàng
                                </div>
                            </div>
                            ...
                            <div class="tile">
                                ...
                                <div class="row">
                                    <div class="form-group  col-md-10">
                                        ...
                                        <input class="form-control" type="text" placeholder="" id="tenKhachHangAdd"
                                            required>
                                    </div>
                                    <div class="form-group col-md-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div id="qrCodeContainer" style="display: none;"><img
                                                src="../../../../assets/img/QR/qr.jpg"
                                                style="height: 430px;width: 430px;text-align: center">
                                        </div>
                                    </div>
                                    <div class="tile-footer col-md-12">
                                        <button class="btn btn-primary luu-va-in" type="button" id="submitButton"> Lưu
                                            đơn hàng (F9)
                                        </button>
                ...
                <script>
                    ...
                    function updateRemainingAmount() {
                        var customerPayment = parseFloat($('#customerPayment').val()) || 0;
                        var totalAmount = parseFloat($('.control-all-money-total').text()) || 0;
                ...
                <script>
                    $(document).ready(function () {
                        ...
                        $("#submitButton").click(function () {
                            ...
                            console.log('sanPhamThanhToanTaiQuayDTOS:', sanPhamThanhToanTaiQuayDTOS);
                    ...
                    function getSelectedProductsData() {
                        ...
                        $('#productTableBody tr').each(function () {
                            ...
                            var giaBanString = row.find('td:eq(4)').text();

                            console.log('Debug - maSanPham:', maSanPham);
                            console.log('Debug - quantity:', quantity);
                            console.log('Debug - giaBanString:', giaBanString);
