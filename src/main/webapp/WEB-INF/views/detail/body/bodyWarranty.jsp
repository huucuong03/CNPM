      ...
      <div class="h-full px-0 tablet:px-medium tablet:bg-pure-white tablet:rounded-1x-large relative">
            ...
            <div class="flex w-full items-center gap-medium bg-pure-white p-small tablet:p-0 tablet:pt-small"   >
               ...
               <div class="cpsui:flex cpsui:gap-2x-small cpsui:group cpsui:flex-col w-full tablet:w-auto tablet:max-w-[300px]">
                  <div class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer">
                     ...
                     <div id="dateError" style="display:none" class="cpsui:flex cpsui:items-center cpsui:gap-2x-small cpsui:text-negative-600 cpsui:text-small">
               ...
               <c:when test="${not empty mapHD}">
                  <c:forEach var="entry" items="${mapHD.entrySet()}">
                     ...
                     <c:forEach var="item" items="${products}">
                        <c:set var="giaApDung" value="${item.giaSauGiam != 0 ? item.giaSauGiam : item.giaTien}" />
                        ...
                        <div class="J632se">
                           <div class="kG_yF0">
                              <div class="ylYzwa" tabindex="0">
                                 <div tabindex="0" style="display:flex;text-align: center;justify-content: space-between;align-items: center;text-overflow: ellipsis;margin-left: 8px;font-size: 14px;font-weight: 600;overflow: hidden;">
                                    <div>
                                       Thời gian đặt hàng:  
                                    ...
                                    <c:choose>
                                       <c:when test="${products[0].moTaTrangThaiDoiTra != null}">
                                          <div>
                                             <span style="color:red;font-size:13px">${products[0].moTaTrangThaiDoiTra} Đổi trả</span>
                                          </div>
                                       </c:when>
                                       <c:otherwise>
                                       </c:otherwise>
                                    ...
                                    <c:choose>
                                       <c:when test="${products[0].moTaTrangThaiBaoHanh != null}">
                                          <div>
                                             <span style="color:red;font-size:13px">${products[0].moTaTrangThaiBaoHanh} bảo hành </span>
                                          </div>
                                       </c:when>
                                       <c:otherwise>
                                       </c:otherwise>
                              ...
                              <div style="display:flex;text-align: center;justify-content: space-between;align-items: center;">
                                 <a>
                                    <div class="bdAfgU">
                                       <c:forEach var="item" items="${products}">
                                          <div class="mZ1OWk">
                                             <div class="dJaa92">
                                                <div class="divimg">
                                                   <img src="http://localhost:8080/img/${item.hinhAnhURL}" class="gQuHsZ" style="object-fit: cover;">
                                                </div>
                                                <div class="nmdHRf">
                                                   <div class="zWrp4w">
                                                   ...
                                                   <div style="font-size: 13px;color: gray">Số lượng: x${item.soLuongMua}</div>
                                                   <div style="font-size: 13px;color: gray">
                                                      Giá bán: 
                                                      <bdi>
                                                         <fmt:formatNumber value="${item.giaSauGiam != 0 ? item.giaSauGiam : item.giaTien}" type="number"/>
                                                         ₫
                                                      </bdi>
                                                   </div>
                                    ...
                                    <div>
                                       ...
                                       <div class="NWUSQP" style="justify-content: center;">
                                          ...
                                          <div class="t7TQaf" tabindex="0" aria-label="Thành tiền: 23000000.0000">
                                             <bdi>
                                 ...
                                 <a class="btnOpenModal" data-ma-hoa-don="${maHD}" data-type="return"> <button class="stardust-button stardust-button--primary QY7kZh" style="background-color: green;" fdprocessedid="u71h1b">Đổi trả</button> </a>
                                 </c:if>
                                 <c:if test="${coTheBaoHanh}">
                                 <a class="btnOpenModal" data-ma-hoa-don="${maHD}" data-type="warranty"> <button class="stardust-button stardust-button--primary QY7kZh" style="background-color: blue;" fdprocessedid="u71h1b">Bảo Hành</button>
                                 </c:if>
                                 <c:if test="${!coTheDoiTra && !coTheBaoHanh}">
                                 <span style="color:red;font-size:13px">Đã gửi yêu cầu hoặc hết thời hạn hỗ trợ</span>
                                 </c:if>
                                 </div>
                                 </a>
                                 </div>
         ...
         <div class="pagination" style="margin-top: 20px; text-align:center;">
            <c:if test="${currentPage > 0}">
               <a href="?page=${currentPage - 1}&size=15">« Trang trước</a>
            </c:if>
            <span> Trang ${currentPage + 1} / ${totalPages} </span>
            <c:if test="${currentPage < totalPages - 1}">
               <a href="?page=${currentPage + 1}&size=15">Trang sau »</a>
            </c:if>
         </div>
      </div>
   </div>
...
<div role="dialog" id="radix-«rk»" style="display:none;" aria-describedby="radix-«rm»" aria-labelledby="radix-«rl»" data-state="open" class="cpsui:fixed cpsui:z-10000 cpsui:inset-y-0 cpsui:right-0 cpsui:h-full cpsui:max-w-[calc(100%-20px)] cpsui:transition cpsui:ease-in-out cpsui:data-[state=open]:animate-in cpsui:data-[state=closed]:animate-out" tabindex="-1">
   <div class="cpsui:bg-pure-white cpsui:tablet:rounded-medium cpsui:flex cpsui:flex-col cpsui:w-full cpsui:h-full cpsui:rounded-l-medium">
      ...
      <div class="w-full tablet:w-[568px] h-full p-small tablet:px-1x-large tablet:py-medium overflow-hidden pb-[92px] tablet:pb-0">
         <form class="w-full h-full flex flex-col gap-medium overflow-auto hidden-scroll relative" action="/detailKh/warranty/return" method="post" enctype="multipart/form-data">
            ...
            <div class="w-full flex flex-1 flex-col gap-medium">
               ...
               <div>
                  <div class="cpsui:flex cpsui:gap-2x-small cpsui:group cpsui:flex-col">
                     <label data-slot="label" class="cpsui:flex cpsui:items-center cpsui:gap-2x-small cpsui:font-medium cpsui:select-none cpsui:group-data-[disabled=true]:pointer-events-none cpsui:group-data-[disabled=true]:opacity-50 cpsui:peer-data-[disabled=true]:cursor-not-allowed cpsui:peer-data-[disabled=true]:opacity-50 cpsui:text-base">Chọn sản phẩm </label>
                     <div class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer">
                        <input type="hidden" value="" name="maChiTietSanPham" id="maChiTietSanPham">
                        <div id="productLabel" aria-controls="radix-«r16»" aria-expanded="false" aria-haspopup="dialog" data-slot="popover-trigger" data-state="closed" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer cpsui:w-full">
                           <div class="cpsui:p-1x-small cpsui:flex cpsui:items-center cpsui:gap-1x-small cpsui:min-w-0 cpsui:border cpsui:transition-colors cpsui:data-[disabled=true]:bg-neutral-100 cpsui:data-[disabled=true]:cursor-not-allowed cpsui:border-neutral-300 cpsui:focus-within:border-neutral-600 cpsui:data-[disabled=true]:border-neutral-200 cpsui:text-base cpsui:min-h-[48px] cpsui:rounded-base cpsui:pl-medium">
                              <input data-slot="input" class="cpsui:w-full cpsui:h-full cpsui:bg-transparent cpsui:border-none cpsui:outline-none cpsui:shadow-none cpsui:ring-0 cpsui:focus:outline-none cpsui:focus:border-none cpsui:focus:ring-0 cpsui:focus-visible:outline-none cpsui:focus-visible:border-none cpsui:focus-visible:ring-0 cpsui:placeholder:text-neutral-300 cpsui:placeholder:select-none cpsui:disabled:opacity-80 cpsui:disabled:cursor-not-allowed cpsui:disabled:text-neutral-500 cpsui:disabled:placeholder:text-neutral-400 cpsui:overflow-hidden cpsui:text-ellipsis cpsui:whitespace-nowrap"
                                 id="productInput" readonly="" placeholder="Chọn sản phẩm" type="text" value="" name="" fdprocessedid="jhuto">
               ...
               <div>
                  <div class="cpsui:flex cpsui:gap-2x-small cpsui:group cpsui:flex-col">
                     <label data-slot="label" class="cpsui:flex cpsui:items-center cpsui:gap-2x-small cpsui:font-medium cpsui:select-none cpsui:group-data-[disabled=true]:pointer-events-none cpsui:group-data-[disabled=true]:opacity-50 cpsui:peer-data-[disabled=true]:cursor-not-allowed cpsui:peer-data-[disabled=true]:opacity-50 cpsui:text-base">Chọn lý do </label>
                     <div id="reasonLabel" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer">
                        <input type="hidden" value="">
                        <div id="reasonLabel" aria-controls="radix-«r16»" aria-expanded="false" aria-haspopup="dialog" data-slot="popover-trigger" data-state="closed" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer cpsui:w-full">
                           <div class="cpsui:p-1x-small cpsui:flex cpsui:items-center cpsui:gap-1x-small cpsui:min-w-0 cpsui:border cpsui:transition-colors cpsui:data-[disabled=true]:bg-neutral-100 cpsui:data-[disabled=true]:cursor-not-allowed cpsui:border-neutral-300 cpsui:focus-within:border-neutral-600 cpsui:data-[disabled=true]:border-neutral-200 cpsui:text-base cpsui:min-h-[48px] cpsui:rounded-base cpsui:pl-medium">
                              <input data-slot="input" class="cpsui:w-full cpsui:h-full cpsui:bg-transparent cpsui:border-none cpsui:outline-none cpsui:shadow-none cpsui:ring-0 cpsui:focus:outline-none cpsui:focus:border-none cpsui:focus:ring-0 cpsui:focus-visible:outline-none cpsui:focus-visible:border-none cpsui:focus-visible:ring-0 cpsui:placeholder:text-neutral-300 cpsui:placeholder:select-none cpsui:disabled:opacity-80 cpsui:disabled:cursor-not-allowed cpsui:disabled:text-neutral-500 cpsui:disabled:placeholder:text-neutral-400 cpsui:overflow-hidden cpsui:text-ellipsis cpsui:whitespace-nowrap"
                                 id="reasonInput" readonly="" placeholder="Chọn lý do" type="text" value="" name="reason" fdprocessedid="jhuto">
                              <div class="cpsui:flex cpsui:items-center cpsui:justify-center cpsui:aspect-square">
                                 <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="cpsui:text-large" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M256 294.1L383 167c9.4-9.4 24.6-9.4 33.9 0s9.3 24.6 0 34L273 345c-9.1 9.1-23.7 9.3-33.1.7L95 201.1c-4.7-4.7-7-10.9-7-17s2.3-12.3 7-17c9.4-9.4 24.6-9.4 33.9 0l127.1 127z"></path>
                                 </svg>
                     ...
                     <div id="reasonWrapper" style=" display:none;max-height: 240px;" class="cpsui:bg-popover cpsui:text-popover-foreground cpsui:data-[state=open]:animate-in cpsui:data-[state=closed]:animate-out cpsui:data-[state=closed]:fade-out-0 cpsui:data-[state=open]:fade-in-0 cpsui:data-[state=closed]:zoom-out-95 cpsui:data-[state=open]:zoom-in-95 cpsui:data-[side=bottom]:slide-in-from-top-2 cpsui:data-[side=left]:slide-in-from-right-2 cpsui:data-[side=right]:slide-in-from-left-2 cpsui:data-[side=top]:slide-in-from-bottom-2 cpsui:z-10000 cpsui:origin-(--radix-popover-content-transform-origin) cpsui:outline-hidden cpsui:text-base cpsui:!p-0 cpsui:rounded-base cpsui:border cpsui:border-neutral-300 cpsui:shadow-sm cpsui:box-border cpsui:[width:var(--radix-popover-trigger-width)]">
               ...
               <div>
                  <div class="cpsui:flex cpsui:gap-2x-small cpsui:group cpsui:flex-col">
                     <label data-slot="label" class="cpsui:flex cpsui:items-center cpsui:gap-2x-small cpsui:font-medium cpsui:select-none cpsui:group-data-[disabled=true]:pointer-events-none cpsui:group-data-[disabled=true]:opacity-50 cpsui:peer-data-[disabled=true]:cursor-not-allowed cpsui:peer-data-[disabled=true]:opacity-50 cpsui:text-base">Hình ảnh sản phẩm lỗi</label>
                     <div id="imglabelError" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer">
                        ...
                        <div aria-controls="radix-«r16»" aria-expanded="false" aria-haspopup="dialog" data-slot="popover-trigger" data-state="closed" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer cpsui:w-full">
                           <div class="cpsui:p-1x-small cpsui:flex cpsui:items-center cpsui:gap-1x-small cpsui:min-w-0 cpsui:border cpsui:transition-colors cpsui:data-[disabled=true]:bg-neutral-100 cpsui:data-[disabled=true]:cursor-not-allowed cpsui:border-neutral-300 cpsui:focus-within:border-neutral-600 cpsui:data-[disabled=true]:border-neutral-200 cpsui:text-base cpsui:min-h-[48px] cpsui:rounded-base cpsui:pl-medium">
                              <input data-slot="input" class="cpsui:w-full cpsui:h-full cpsui:bg-transparent cpsui:border-none cpsui:outline-none cpsui:shadow-none cpsui:ring-0 cpsui:focus:outline-none cpsui:focus:border-none cpsui:focus:ring-0 cpsui:focus-visible:outline-none cpsui:focus-visible:border-none cpsui:focus-visible:ring-0 cpsui:placeholder:text-neutral-300 cpsui:placeholder:select-none cpsui:disabled:opacity-80 cpsui:disabled:cursor-not-allowed cpsui:disabled:text-neutral-500 cpsui:disabled:placeholder:text-neutral-400 cpsui:overflow-hidden cpsui:text-ellipsis cpsui:whitespace-nowrap"
                                 id="imgErrorInput" placeholder="Hinh anh san pham loi" type="file" accept="image/*" name="images" fdprocessedid="jhuto" multiple>
                              <div class="cpsui:flex cpsui:items-center cpsui:justify-center cpsui:aspect-square">
                                 <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="cpsui:text-large" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M256 294.1L383 167c9.4-9.4 24.6-9.4 33.9 0s9.3 24.6 0 34L273 345c-9.1 9.1-23.7 9.3-33.1.7L95 201.1c-4.7-4.7-7-10.9-7-17s2.3-12.3 7-17c9.4-9.4 24.6-9.4 33.9 0l127.1 127z"></path>
                                 </svg>
                     ...
                     <div id="imgErrorWrapper" style=" display:none;max-height: 240px;justify-content: center;" class="cpsui:bg-popover cpsui:text-popover-foreground cpsui:data-[state=open]:animate-in cpsui:data-[state=closed]:animate-out cpsui:data-[state=closed]:fade-out-0 cpsui:data-[state=open]:fade-in-0 cpsui:data-[state=closed]:zoom-out-95 cpsui:data-[state=open]:zoom-in-95 cpsui:data-[side=bottom]:slide-in-from-top-2 cpsui:data-[side=left]:slide-in-from-right-2 cpsui:data-[side=right]:slide-in-from-left-2 cpsui:data-[side=top]:slide-in-from-bottom-2 cpsui:z-10000 cpsui:origin-(--radix-popover-content-transform-origin) cpsui:outline-hidden cpsui:text-base cpsui:!p-0 cpsui:rounded-base cpsui:border cpsui:border-neutral-300 cpsui:shadow-sm cpsui:box-border cpsui:[width:var(--radix-popover-trigger-width)]">
                        <div class="dropdown" id="imgErrorList" >
                           <div class="dropdown__item cpsui:p-1x-small cpsui:hover:bg-neutral-100 cpsui:cursor-pointer cpsui:rounded-base cpsui:flex cpsui:items-center cpsui:gap-2x-small" data-code="91">Đổi tại cửa hàng</div>
                           <div class="dropdown__item cpsui:p-1x-small cpsui:hover:bg-neutral-100 cpsui:cursor-pointer cpsui:rounded-base cpsui:flex cpsui:items-center cpsui:gap-2x-small" data-code="91">Gửi về kho</div>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div>
                  <div class="cpsui:flex cpsui:gap-2x-small cpsui:group cpsui:flex-col">
                     <label data-slot="label" class="cpsui:flex cpsui:items-center cpsui:gap-2x-small cpsui:font-medium cpsui:select-none cpsui:group-data-[disabled=true]:pointer-events-none cpsui:group-data-[disabled=true]:opacity-50 cpsui:peer-data-[disabled=true]:cursor-not-allowed cpsui:peer-data-[disabled=true]:opacity-50 cpsui:text-base">Chọn phương thức</label>
                     <div id="phuongThuclabel" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer">
                        <input type="hidden" value="">
                        <div aria-controls="radix-«r16»" aria-expanded="false" aria-haspopup="dialog" data-slot="popover-trigger" data-state="closed" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer cpsui:w-full">
                           <div class="cpsui:p-1x-small cpsui:flex cpsui:items-center cpsui:gap-1x-small cpsui:min-w-0 cpsui:border cpsui:transition-colors cpsui:data-[disabled=true]:bg-neutral-100 cpsui:data-[disabled=true]:cursor-not-allowed cpsui:border-neutral-300 cpsui:focus-within:border-neutral-600 cpsui:data-[disabled=true]:border-neutral-200 cpsui:text-base cpsui:min-h-[48px] cpsui:rounded-base cpsui:pl-medium">
                              <input data-slot="input" class="cpsui:w-full cpsui:h-full cpsui:bg-transparent cpsui:border-none cpsui:outline-none cpsui:shadow-none cpsui:ring-0 cpsui:focus:outline-none cpsui:focus:border-none cpsui:focus:ring-0 cpsui:focus-visible:outline-none cpsui:focus-visible:border-none cpsui:focus-visible:ring-0 cpsui:placeholder:text-neutral-300 cpsui:placeholder:select-none cpsui:disabled:opacity-80 cpsui:disabled:cursor-not-allowed cpsui:disabled:text-neutral-500 cpsui:disabled:placeholder:text-neutral-400 cpsui:overflow-hidden cpsui:text-ellipsis cpsui:whitespace-nowrap"
                                 id="phuongThucInput" readonly="" placeholder="Chọn phương thức" type="text" value="" name="phuongThuc" fdprocessedid="jhuto">
                              <div class="cpsui:flex cpsui:items-center cpsui:justify-center cpsui:aspect-square">
                                 <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="cpsui:text-large" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M256 294.1L383 167c9.4-9.4 24.6-9.4 33.9 0s9.3 24.6 0 34L273 345c-9.1 9.1-23.7 9.3-33.1.7L95 201.1c-4.7-4.7-7-10.9-7-17s2.3-12.3 7-17c9.4-9.4 24.6-9.4 33.9 0l127.1 127z"></path>
                                 </svg>
                     ...
                     <div id="phuongThucWrapper" style=" display:none;max-height: 240px;" class="cpsui:bg-popover cpsui:text-popover-foreground cpsui:data-[state=open]:animate-in cpsui:data-[state=closed]:animate-out cpsui:data-[state=closed]:fade-out-0 cpsui:data-[state=open]:fade-in-0 cpsui:data-[state=closed]:zoom-out-95 cpsui:data-[state=open]:zoom-in-95 cpsui:data-[side=bottom]:slide-in-from-top-2 cpsui:data-[side=left]:slide-in-from-right-2 cpsui:data-[side=right]:slide-in-from-left-2 cpsui:data-[side=top]:slide-in-from-bottom-2 cpsui:z-10000 cpsui:origin-(--radix-popover-content-transform-origin) cpsui:outline-hidden cpsui:text-base cpsui:!p-0 cpsui:rounded-base cpsui:border cpsui:border-neutral-300 cpsui:shadow-sm cpsui:box-border cpsui:[width:var(--radix-popover-trigger-width)]">
               ...
               <!-- Thông tin bổ sung -->
               <div>
                  <div style="margin-bottom: 6px;" class="cpsui:flex cpsui:items-center cpsui:gap-2x-small cpsui:font-medium cpsui:select-none cpsui:group-data-[disabled=true]:pointer-events-none cpsui:group-data-[disabled=true]:opacity-50 cpsui:peer-data-[disabled=true]:cursor-not-allowed cpsui:peer-data-[disabled=true]:opacity-50 cpsui:text-base">Thông tin liên hệ:</div>
                  <div class="field-group" style="display:flex;margin: 13px 0;">
                     <div class="box-input">
                        <input  type="text" placeholder="Họ tên người nhận" maxlength="1000" autocomplete="off" class="box-input__main" fdprocessedid="ylt7jb" id="tenKhachHang" name="tenKhachHang"> <label >TÊN NGƯỜI NHẬN</label> 
                        <div  class="box-input__line"></div>
                     </div>
                     <div class="box-input">
                        <input type="text" placeholder="Số điện thoại người nhận" maxlength="10" autocomplete="off" class="box-input__main" fdprocessedid="rv67n"id="sdtKhachHang" name="sdtKhachHang"> <label >SĐT NGƯỜI NHẬN</label> 
                        <div  class="box-input__line"></div>
                     </div>
                  </div>
               </div>
               <%-- <!-- Địa chỉ cửa hàng -->
                  <div>
                      <div class="cpsui:flex cpsui:gap-2x-small cpsui:group cpsui:flex-col">
                        <label data-slot="label" class="cpsui:flex cpsui:items-center cpsui:gap-2x-small cpsui:font-medium cpsui:select-none cpsui:group-data-[disabled=true]:pointer-events-none cpsui:group-data-[disabled=true]:opacity-50 cpsui:peer-data-[disabled=true]:cursor-not-allowed cpsui:peer-data-[disabled=true]:opacity-50 cpsui:text-base">Địa chỉ cửa hàng</label>
                        <div class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer">
                           <input type="hidden" value="">
                           <div aria-controls="radix-«r16»" aria-expanded="false" aria-haspopup="dialog" data-slot="popover-trigger" data-state="closed" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer cpsui:w-full">
                              <div class="cpsui:p-1x-small cpsui:flex cpsui:items-center cpsui:gap-1x-small cpsui:min-w-0 cpsui:border cpsui:transition-colors cpsui:data-[disabled=true]:bg-neutral-100 cpsui:data-[disabled=true]:cursor-not-allowed cpsui:border-neutral-300 cpsui:focus-within:border-neutral-600 cpsui:data-[disabled=true]:border-neutral-200 cpsui:text-base cpsui:min-h-[48px] cpsui:rounded-base cpsui:pl-medium">
                                 <p data-slot="input" class="cpsui:w-full cpsui:h-full cpsui:bg-transparent cpsui:border-none cpsui:outline-none cpsui:shadow-none cpsui:ring-0 cpsui:focus:outline-none cpsui:focus:border-none cpsui:focus:ring-0 cpsui:focus-visible:outline-none cpsui:focus-visible:border-none cpsui:focus-visible:ring-0 cpsui:placeholder:text-neutral-300 cpsui:placeholder:select-none cpsui:disabled:opacity-80 cpsui:disabled:cursor-not-allowed cpsui:disabled:text-neutral-500 cpsui:disabled:placeholder:text-neutral-400 cpsui:overflow-hidden cpsui:text-ellipsis cpsui:whitespace-nowrap"
                                    id="provinceInput" readonly="" placeholder="Địa chỉ cửa hàng" type="text" value="" name="tinh" fdprocessedid="jhuto">
                                 <div class="cpsui:flex cpsui:items-center cpsui:justify-center cpsui:aspect-square">aaa</p>
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="cpsui:text-large" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M256 294.1L383 167c9.4-9.4 24.6-9.4 33.9 0s9.3 24.6 0 34L273 345c-9.1 9.1-23.7 9.3-33.1.7L95 201.1c-4.7-4.7-7-10.9-7-17s2.3-12.3 7-17c9.4-9.4 24.6-9.4 33.9 0l127.1 127z"></path>
                                    </svg>
                                 </div>
               ...
               <div>
                  <div class="cpsui:flex cpsui:gap-2x-small cpsui:group cpsui:flex-col">
                     <label data-slot="label" class="cpsui:flex cpsui:items-center cpsui:gap-2x-small cpsui:font-medium cpsui:select-none cpsui:group-data-[disabled=true]:pointer-events-none cpsui:group-data-[disabled=true]:opacity-50 cpsui:peer-data-[disabled=true]:cursor-not-allowed cpsui:peer-data-[disabled=true]:opacity-50 cpsui:text-base">Chọn địa chỉ</label>
                     <div id="addresslabel" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer">
                        ...
                        <div  aria-controls="radix-«r16»" aria-expanded="false" aria-haspopup="dialog" data-slot="popover-trigger" data-state="closed" class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer cpsui:w-full">
                           <div class="cpsui:p-1x-small cpsui:flex cpsui:items-center cpsui:gap-1x-small cpsui:min-w-0 cpsui:border cpsui:transition-colors cpsui:data-[disabled=true]:bg-neutral-100 cpsui:data-[disabled=true]:cursor-not-allowed cpsui:border-neutral-300 cpsui:focus-within:border-neutral-600 cpsui:data-[disabled=true]:border-neutral-200 cpsui:text-base cpsui:min-h-[48px] cpsui:rounded-base cpsui:pl-medium">
                              <input data-slot="input" class="cpsui:w-full cpsui:h-full cpsui:bg-transparent cpsui:border-none cpsui:outline-none cpsui:shadow-none cpsui:ring-0 cpsui:focus:outline-none cpsui:focus:border-none cpsui:focus:ring-0 cpsui:focus-visible:outline-none cpsui:focus-visible:border-none cpsui:focus-visible:ring-0 cpsui:placeholder:text-neutral-300 cpsui:placeholder:select-none cpsui:disabled:opacity-80 cpsui:disabled:cursor-not-allowed cpsui:disabled:text-neutral-500 cpsui:disabled:placeholder:text-neutral-400 cpsui:overflow-hidden cpsui:text-ellipsis cpsui:whitespace-nowrap"
                                 id="addressInput" readonly="" placeholder="Chọn địa chỉ" type="text" value=""  fdprocessedid="jhuto">
                              <div class="cpsui:flex cpsui:items-center cpsui:justify-center cpsui:aspect-square">
                                 <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="cpsui:text-large" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M256 294.1L383 167c9.4-9.4 24.6-9.4 33.9 0s9.3 24.6 0 34L273 345c-9.1 9.1-23.7 9.3-33.1.7L95 201.1c-4.7-4.7-7-10.9-7-17s2.3-12.3 7-17c9.4-9.4 24.6-9.4 33.9 0l127.1 127z"></path>
                                 </svg>
                     ...
                     <div id="addressWrapper" style=" display:none;max-height: 240px;" class="cpsui:bg-popover cpsui:text-popover-foreground cpsui:data-[state=open]:animate-in cpsui:data-[state=closed]:animate-out cpsui:data-[state=closed]:fade-out-0 cpsui:data-[state=open]:fade-in-0 cpsui:data-[state=closed]:zoom-out-95 cpsui:data-[state=open]:zoom-in-95 cpsui:data-[side=bottom]:slide-in-from-top-2 cpsui:data-[side=left]:slide-in-from-right-2 cpsui:data-[side=right]:slide-in-from-left-2 cpsui:data-[side=top]:slide-in-from-bottom-2 cpsui:z-10000 cpsui:origin-(--radix-popover-content-transform-origin) cpsui:outline-hidden cpsui:text-base cpsui:!p-0 cpsui:rounded-base cpsui:border cpsui:border-neutral-300 cpsui:shadow-sm cpsui:box-border cpsui:[width:var(--radix-popover-trigger-width)]">
            ...
            <div class="shadow-group-button w-full flex items-center gap-1x-small tablet:gap-medium tablet:box-content px-1x-small tablet:px-0 py-medium fixed tablet:sticky z-[9999] bottom-0 left-0 right-0 bg-pure-white">
               <button type="submit" class="cpsui:flex cpsui:items-center cpsui:justify-center cpsui:gap-2x-small cpsui:cursor-pointer cpsui:border cpsui:border-primary-500 cpsui:bg-primary-500 cpsui:text-pure-white cpsui:rounded-base cpsui:px-medium cpsui:py-1x-small w-full font-medium">Gửi yêu cầu</button>
            </div>
      </div>
   </div>
   <!-- Button submit -->
