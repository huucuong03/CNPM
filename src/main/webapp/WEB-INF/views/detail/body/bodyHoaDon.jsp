               ...
               <div class="h-full px-0 tablet:px-medium tablet:bg-pure-white tablet:rounded-1x-large relative">
                        ...
                        <div
                           ...
                           <div class="cpsui:flex cpsui:flex-col cpsui:gap-2x-small cpsui:peer">
                              ...
                              <div id="dateError" style="display:none"
                                 ...
                                 </svg>Định dạng ngày không hợp lệ</div>
                           </div>
                        </div>
                     </div>
                  </div>
                                                   ...
                                                   <span class="O2yAdQ">
                                                      <c:choose>
                                                         <c:when test="${hd.trangThai == 0}">
                                                            <div
                                                               style="color: #141414ff;width: 85px;text-align: center;background-color: yellow;border-radius: 8%;">
                                                               Chờ xử lý</div>
                                                         </c:when>
                                                         <c:when test="${hd.trangThai == 1}">
                                                            <div
                                                               style="color: #0e0ebd;width: 85px;text-align: center;background-color: #d2d2ff;border-radius: 8%;">
                                                               Đang giao</div>
                                                         </c:when>
                                                         <c:when test="${hd.trangThai == 2}">
                                                            <div style="color:green">Đã giao</div>
                                                         </c:when>
                                                         <c:otherwise> <span style="color:red;">Đã Hủy</span>
                                                         </c:otherwise>
                                                      </c:choose>
                                                   </span>
                                                </div>
                                                         ...
                                                         <c:if test="${not empty maxCt}">
                                                            <div class="mZ1OWk">
                                                               <div class="dJaa92">
                                                                  <div class="divimg">
                                                                     <img
                                                                        src="http://localhost:8080/img/${maxCt.chiTietSanPham.hinhAnhURL}"
                                                                        class="gQuHsZ" style="object-fit: cover;" alt=""
                                                                        tabindex="0"
                                                                        elementtiming="shopee:heroComponentPaint">
                                                                  </div>
                                                                  <div class="nmdHRf">
                                                                     <div>
                                                                        <div class="zWrp4w"><span class="DWVWOJ"
                                                                              tabindex="0">${maxCt.chiTietSanPham.sanPham.tenSanPham}
                                                                              ${maxCt.chiTietSanPham.dungLuong.tenDungLuong}
                                                                              ${maxCt.chiTietSanPham.mauSac.tenMauSac}</span>
                                                                        </div>
                                                                     </div>
                                                                     <div>
                                                                        <div class="rsautk" tabindex="0">Phân loại:
                                                                           ${maxCt.chiTietSanPham.nsx.tenNSX}</div>
                                                                        <div class="j3I_Nh" tabindex="0">
                                                                           x${maxCt.soLuongMua}</div>
                                                                     </div>
                                                                  </div>
                                                               </div>
                                                               <div>
                                                                  <div class="NWUSQP" style="margin-bottom: 10px;">
                                                                     ...
                                                                     <div class="t7TQaf" tabindex="0"
                                                                        aria-label="Thành tiền: ${hd.tongTien}">
                                                                        <bdi>
                                                                           <fmt:formatNumber value="${hd.tongTien}"
                                                                              type="number" />
                                                                           <span
                                                                  ...
                                                                  <div class="aAXjeK" style="margin: 0 30px;">
                                                                     <div>
                                                                        <form id="checkoutForm" action="/cart/check-out"
                                                                           method="post">
                                                                           <input type="hidden" name="maGHCTs"
                                                                              id="checkoutMaGHCTs">
                                                                        </form>
                                                                        <button id="btnMuaLai"
                                                                           class="stardust-button stardust-button--primary QY7kZh"
                                                                           fdprocessedid="u71h1b">Mua lại</button>
                                                                     </div>
                                                                  </div>
                                                               </div>
                                                            </div>
                              ...
                              <div class="w-full">
                                 <div class="w-full flex flex-col gap-1x-small tablet:gap-medium">
                                    <div
                                       ...
                                       <img alt="empty" title="empty" loading="lazy" width="420" height="312"
                                       ...
                                       <div
                                          ...
                                          <span class="mr-1x-small">Bạn chưa có đơn hàng nào</span><a
                                             class="text-primary-500 hover:underline shrink-0 " href="/">Trang chủ</a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="pagination"
                     ...
                     <c:if test="${currentPage > 0}">
                        <a href="?trangThai=${trangThai}&startDate=${startDate}&endDate=${endDate}&page=${currentPage - 1}&size=${size}"
