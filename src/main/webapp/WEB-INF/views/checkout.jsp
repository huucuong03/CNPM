      ...
      <%@ include file="toast.jsp" %>
         ...
         <div class="super-cart-container" style="padding-top: 15px;">
            ...
            <div class="block-info">
               <div class="block-box">
                        ...
                        <c:forEach var="item" items="${listghct}">
                           ...
                           <div class="item" data-maghct="${ghct.magiohangchitiet}">
                              ...
                              <div class="item__info">
                                 <p class="item__name">
                                    ${ghct.chiTietSanPham.sanPham.tenSanPham} (${ghct.chiTietSanPham.sanPham.maSanPham})
                                    - ${ghct.chiTietSanPham.mauSac.tenMauSac}
                                 </p>
                                 <div class="item__price">
                                    <div class="block-box-price">
                                       <div class="box-info__box-price">
                                          <c:choose>
                                             <c:when
                                                test="${giamGia != null && giamGia.giaSauKhiGiam != null && giamGia.giaSauKhiGiam < ghct.chiTietSanPham.giaBan}">
                                                <p class="product__price--show">
                                                   <fmt:formatNumber value="${giamGia.giaSauKhiGiam}" type="number"
                                                      groupingUsed="true" />
                                                   đ
                                                </p>
                                                <p class="product__price--through">
                                                   <fmt:formatNumber value="${ghct.chiTietSanPham.giaBan}" type="number"
                                                      groupingUsed="true" />
                                                   đ
                                                </p>
                                             </c:when>
                  ...
                  <form id="myForm" action="/cart/submit-order" method="post">
                           ...
                           <div class="block-customer__main">
                              <div class="customer-input__1">
                                 <div class="customer-name">
                                    ...
                                    <span data-v-04f8aa41="" class="level"
                                       style="color: rgb(231, 55, 183); border: 1px solid rgb(231, 55, 183); white-space: nowrap;">
                                       S-NULL
                                    </span>
                                 </div>
                     ...
                     <div class="block-payment-info">
                        <p class="block-payment-info__title">Phương thức thanh toán</p>
                        <div class="block-payment-info__main">
                           ...
                           <div class="payment-info-main">
                              <div class="payment-info-wrapper">
                                       ...
                                       <div class="field-group-wrapper">
                                          <div class="field-group-wrapper__child-1">
                                             <div class="box-input box-input--hasvalue">
                                                <input type="text" id="provinceInput" placeholder="Tỉnh / Thành phố"
                                                   autocomplete="off" class="box-input__main" name="tinh">
                                          ...
                                          <div class="box-input box-input--hasvalue">
                                             <input type="text" id="wardInput" placeholder="Phường / Xã"
                                                autocomplete="off" class="box-input__main" name="xa">
                                 ...
                                 <div class="box-input">
                                    <input type="text" placeholder="Ghi chú khác (nếu có)" maxlength="255"
                                       autocomplete="off" class="box-input__main" fdprocessedid="polgh" name="note">
                                    <label>GHI CHÚ</label>
                                    <div class="box-input__line"></div>
                  ...
                  <%-- <div class="block-payment-info__main"
                     style="margin-top: 20px; margin-bottom: 20px; background-color: rgb(255, 255, 255);">
                     <div class="vat-info">
                        <div class="block-payment__checkvat">
                           <div class="checkvat__checkbox">
                              <div class="checkvat-confirm">
                                 ...
                                 <div>
                                    <div><input id="VAT-Yes" type="radio" name="VAT" value="true"> <label
                                          for="VAT-Yes">Có</label></div>
                                    <div><input id="VAT-No" type="radio" name="VAT" value="false"> <label
                                          for="VAT-No">Không</label></div>
                                 </div>
                              </div>
                              <!----> <!----> <!---->
                           </div>
               ...
               <div
                  style="margin-top: 20px; margin-bottom: 50px; display: flex; justify-content: center; align-items: center;">
                  <!---->
               </div>
            </div>
         </div>
