                                    ...
                                    <div class="main_menu d-none d-lg-block">
                                        <nav>
                                            <ul>
                                                ...
                                                <li><a href="shop.html">Smartphones</a>
                                        ...
                                        <div class="tab-content produc_tab_c">
                                            <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                                                <div class="modal_img">
                                                    ...
                                                    <div class="view_img">
                                                        <a class="large_view"
                                                            href="assets\img\product\productbig.jpg"><i
                                            ...
                                            <div class="tab-pane fade" id="p_tab2" role="tabpanel">
                                                <div class="modal_img">
                                                    ...
                                                    <div class="view_img">
                                                        <a class="large_view"
                                                            href="assets\img\product\productbig1.jpg"><i
                                                                class="fa fa-search-plus"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="p_tab3" role="tabpanel">
                                                <div class="modal_img">
                                                    ...
                                                    <div class="view_img">
                                                        <a class="large_view" href="assets\img\product\productbig2.jpg">
                                                ...
                                                <li>
                                                    <a class="active" data-toggle="tab" href="#p_tab1" role="tab"
                                                        aria-controls="p_tab1" aria-selected="false"><img
                                                            src="assets\img\cart\cart.jpg" alt=""></a>
                                                </li>
                                                <li>
                                                    <a data-toggle="tab" href="#p_tab2" role="tab"
                                                        aria-controls="p_tab2" aria-selected="false"><img
                                                            src="assets\img\cart\cart2.jpg" alt=""></a>
                                                </li>
                                                <li>
                                                    <a data-toggle="tab" href="#p_tab3" role="tab"
                                                        aria-controls="p_tab3" aria-selected="false"><img
                                                            src="assets\img\cart\cart4.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="product_d_right">
                                        ...
                                        <div class="product_desc">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati modi
                                                culpa voluptates illo, quos magni totam inventore delectus perspiciatis
                                                necessitatibus, iure rerum! Deleniti nobis voluptatibus minus, iusto
                                                ullam quae esse..</p>
                                        </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                ...
                                                <div class="product_info">
                                                    <ul>
                                                        <li><a href="#" title=" Add to Wishlist ">Add to Wishlist</a>
                                                        </li>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    <h3 class="product_title"><a href="single-product.html">Sed non
                                                            turpiss</a></h3>
                                                </div>
                                                <div class="product_info">
                                                    <ul>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    <h3 class="product_title"><a href="single-product.html">Duis
                                                            convallis</a></h3>
                                                </div>
                                                <div class="product_info">
                                                    <ul>
